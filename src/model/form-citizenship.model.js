...
const FormCitizenshipSchema = new Schema({
  // marital status
  ...
  // information
  p_citizenship_info_001: {type: String, default: null, required: true},
  p_citizenship_info_002: {type: String, default: null, required: true},
  p_citizenship_info_003: {type: String, default: null, required: true},
  p_citizenship_info_004: {type: String, default: null, required: true},
  // p_citizenship_info_005: {type: String, default: null, required: true},
  ...
  // Other language test
  p_other_lang_test_001: {type: String, default: null, required: true},
  p_other_lang_test_002: {type: String, default: null},
  p_other_lang_test_sp_001: {type: String, default: null},
  p_other_lang_test_sp_002: {type: String, default: null},
...
// FormCitizenshipSchema.plugin(uniqueValidator, {message: '{PATH} is not unique'});

/**
 * Hook to before to save user to encrypt password
 */
FormCitizenshipSchema.pre('save', async function (next) {
  const form = this;
...
FormCitizenshipSchema.pre('findOneAndUpdate', async function (next) {
...
module.exports = BaseForm.discriminator(visaCategories.citizenship, FormCitizenshipSchema);
